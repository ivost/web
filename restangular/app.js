angular.module('project', ['restangular', 'ngRoute']).
  config(function($routeProvider, RestangularProvider) {
    $routeProvider.
      ...
      RestangularProvider.setBaseUrl('https://api.mongolab.com/api/1/databases/mydb/collections');
      RestangularProvider.setDefaultRequestParams({ apiKey: 'iRz2hVWJ9ahesS-ht5jaRbQzaGUwr44M' })
